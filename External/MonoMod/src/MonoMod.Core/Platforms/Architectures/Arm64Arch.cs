        ...
        private static BytePatternCollection CreateKnownMethodThunks()
        {
            ...
            if (PlatformDetection.Runtime is RuntimeKind.Framework or RuntimeKind.CoreCLR)
            {
                return new BytePatternCollection(
                    ...
                    new(new(AddressKind.Rel64 | AddressKind.Constant | AddressKind.Indirect, relativeOffset: 0, constantValue: 0x4000), mustMatchAtStart: true, armInsts(
                        0x5802000b, // ldr	x11, 0x4000
                        0xd61f0160, // br	x11          // If the method hasn't been compiled yet, this will jump to the next instruction
                    ...
                    // https://github.com/dotnet/runtime/blob/17d88ed72da4b70821159169499a805b87739ee6/src/coreclr/vm/arm64/thunktemplates.S#L17-L23
                    new(new(AddressKind.PrecodeFixupThunkRel64 | AddressKind.Constant | AddressKind.Indirect, relativeOffset: 0, constantValue: 0x4008), mustMatchAtStart: true, armInsts(
                        0x5802000c, // ldr	x12, 0x4008
                        0x5802002b, // ldr	x11, 0x4010
                        0xd61f0160  // br	x11
                    )),
                    ...
                    new(new(AddressKind.Rel64 | AddressKind.Constant | AddressKind.Indirect, relativeOffset: 0, constantValue: 0x4008), mustMatchAtStart: true, armInsts(
