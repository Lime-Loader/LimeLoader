    ...
    internal class Cpp2IL : Models.ExecutablePackage
    {
        ...
        internal override bool Execute()
        {
            ...
            var result = new Cpp2IlRuntimeArgs()
            {
                ...
                OutputFormats = [OutputFormatRegistry.GetFormat("dummydll")],
        ...
        private bool RunCpp2IL(Cpp2IlRuntimeArgs runtimeArgs)
        {
            ...
            if (runtimeArgs.OutputFormats != null)
                foreach (var format in runtimeArgs.OutputFormats)
            ...
            if (runtimeArgs.OutputFormats != null && runtimeArgs.OutputFormats.Any())
            {
                foreach (var format in runtimeArgs.OutputFormats)
                {
                    Core.Logger.Msg($"Outputting as {format.OutputFormatName} to {runtimeArgs.OutputRootDirectory}...");
