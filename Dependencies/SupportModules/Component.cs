...
namespace MelonLoader.Support
{
    internal class SM_Component : MonoBehaviour
    {
        ...
        internal static void Create()
        {
            ...
            Main.obj = new GameObject(GenerateRandomName());
        ...
        // Generates a fresh, unpredictable name for the loader's setup GameObject on every run
        // so it can't be found by a hard-coded name. Produces lowercase alphanumeric strings of
        // varying length (e.g. "2hub4t843", "un2jmnajk").
        private static string GenerateRandomName()
        {
            const string alphabet = "abcdefghijklmnopqrstuvwxyz0123456789";
            System.Random random = new System.Random(unchecked(Environment.TickCount * 31 + Guid.NewGuid().GetHashCode()));
